...
class Usuario {
    ...
    ///// Para montar uma lista de usuarios /////////////////////
    ...
    public function login($login, $password){
        ...
        $sql = new Sql();
        $results = $sql->select("SELECT * FROM tb_usuario WHERE deslogin = :LOGIN AND dessenha = :PASSAWORD", 
        ...
        if(count($results) > 0){
            ...
            throw new Exception("Login e/ou senha ivalidos.");
        }
    }
